...
const compressImage = (file: File): Promise<Blob | File> => {
  ...
  return new Promise((resolve) => {
    // 6-second safety timeout to prevent hanging the submission flow on slow browsers
            ...
            <form id="property-upload-form" className="space-y-8 pb-32 md:pb-10" onSubmit={handleSubmit}>
              ...
              <div className="sticky bottom-0 -mx-6 -mb-6 md:-mx-8 md:-mb-8 p-4 bg-white shadow-[0_-10px_20px_rgba(0,0,0,0.05)] border-t border-gray-100 z-[70] mt-10">
                ...
                <button 
                  ...
                  onClick={(e) => {
                    // Prevent default form behavior if we programmatically invoke the submit handler
                    // This bypasses iOS Safari and standalone iframe form delivery issues
                    if (!isSubmitting) {
                      e.preventDefault();
                      handleSubmit(e);
                    }
                  }}
                  className="w-full py-5 bg-blue-600 text-white rounded-2xl font-black text-sm uppercase tracking-widest hover:bg-blue-700 active:bg-blue-800 transition-all flex items-center justify-center gap-2 shadow-xl shadow-blue-200 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {isSubmitting ? (
                    <>
